...
sudo echo "Welcome! This is the Auto-Scaling Demo from Dustin Godfery at Go Cloud Engineers! Hit refresh a few times to see it in action!" >> /var/www/html/index.html
